...
public class CustomerView implements Observer {
    class Name {                          // Names of buttons
        ...
        public static final String CHANGE_COLOR = "BG Col";
    }
    ...
    private final JButton theBtChangeColor = new JButton(Name.CHANGE_COLOR);
    ...
    public CustomerView(RootPaneContainer rpc, MiddleFactory mf, int x, int y) {
        ...
        theBtChangeColor.setBounds(280, 15 + 60 * 0, 80, 30); // Change Color button
