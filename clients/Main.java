...
import backdrop_frame.FullScreenBackgroundFrame;
import java.awt.*;
...
class Main {
     ...
     */
    public void begin() {
        // Create the full-screen background
        FullScreenBackgroundFrame background = new FullScreenBackgroundFrame();
        JFrame backgroundWindow = background.createFullScreenBackground();

        // Create and start other clients
